<?php
/**
 * Code de CodexWorld beaucoup modifié par mes soins
 *
 * This Downloader class helps to download youtube video.
 *
 * @class       YouTubeDownloader
 * @author      CodexWorld, Julien Giraud
...
class YouTubeDownloader {
    ...
    public function getVideoUrl(){
        return "https://www.youtube.com/watch?v=" . $this->extractVideoId($this->video_url);
    }
    ...
    public function extractVideoId($video_url){
        ...
        if($parsed_url["path"] == "youtube.com/watch"){
            ...
            $this->video_url = "https://www.youtube.com/watch?v=" . substr($parsed_url["query"], 2);
        }elseif ($parsed_url["path"][0] == "/") {
            $suite = $parsed_url["path"];
            $this->video_url = "https://www.youtube.com/watch?v=" . substr($parsed_url["path"], 1);
        }
        ...
        if(isset($parsed_url["path"])){
            return substr($parsed_url["path"], 1);
        }
    }
